...
import { ExpenseType } from "@/pages/ExpensesPage";
...
const Expense: React.FC<ExpenseProps>= ({data, refresh}) => {
    ...
    return (
        <Card style={{backgroundColor: "#E6E8E6"}}>
            <VStack>
                <Pressable onPress={() => nav.navigate('ExpenseInfo', {data: data, refresh: refresh})}>
